          ...
          <div className="container-custom max-w-3xl">
            ...
            <div className="prose prose-sm max-w-none space-y-6 text-text-muted">
              <div>
                ...
                <p>
                  Estos términos regulan el uso de la web pacientessevilla.com y los servicios de marketing digital que ofrecemos
              ...
              <div>
                ...
                <p>
                  Pacientes Sevilla no se responsabiliza por: (a) Interrupción o indisponibilidad temporal de la web; (b)
              ...
              <div>
                ...
                <p>
                  Todo contenido de esta web (textos, imágenes, logotipos, diseño) es propiedad de Pacientes Sevilla o sus
