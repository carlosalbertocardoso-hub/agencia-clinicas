      ...
      <div className="container-custom">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-base sm:text-lg text-text-muted leading-relaxed">
            No todas las agencias entienden que la publicidad médica en Sevilla está sujeta a normativas estrictas. En iclinicas trabajamos bajo el marco de la Ley de Publicidad Sanitaria y los códigos deontológicos, asegurando que tu captación sea tan rigurosa como tu práctica médica.
          </p>
        </div>
