  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 md:hidden px-3 pb-3 pointer-events-none">
      <div className="pointer-events-auto grid grid-cols-2 gap-2 rounded-lg border border-slate-200 bg-white p-2 shadow-lg">
        ...
        <a
          href="https://wa.me/34600258938?text=Hola%20iCl%C3%ADnicas%2C%20quiero%20solicitar%20la%20auditor%C3%ADa%20gratuita%20para%20mi%20cl%C3%ADnica."
          aria-label="Contactar por WhatsApp con iClínicas"
          target="_blank"
